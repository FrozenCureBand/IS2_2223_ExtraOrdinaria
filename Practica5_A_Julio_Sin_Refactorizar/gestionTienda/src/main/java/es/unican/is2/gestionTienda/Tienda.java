 ...
 *
 * CBO: 4 (Se calcula contando el número de clases acopladas directamente a la clase Tienda, en este caso: Vendedor, VendedorEnPlantilla, TipoVendedor, vendedorEnPracticas)
 * WMC: 9 (Se calcula contando el número de métodos en la clase Tienda, en este caso: Tienda, direccion, nombre, anhade, eliminaVendedor, anhadeVenta, buscaVendedor, vendedores, vuelcaDatos)
